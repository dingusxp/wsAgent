...
actions[Protocol.INTERNAL_QUERY_ACTIONS.AUTH] = function(param) {
    ...
    if (this.userId) {
        ...
        if (this.userId === userId) {
            ...
            logger.warn(`${userId} login conflict with ${this.userId}`);
...
actions[Protocol.INTERNAL_QUERY_ACTIONS.SUBSCRIBE] = function(param) {
    ...
    // logger.debug(`${this.clientId} subscribe ${channelName}; new client count: ${serverContext.channelClientCount[channelName]}`);
...
actions[Protocol.INTERNAL_QUERY_ACTIONS.UNSUBSCRIBE] = function(param) {
    ...
    // logger.debug(`${this.clientId} unsubscribe ${channelName}; new client count: ${serverContext.channelClientCount[channelName]}`);
